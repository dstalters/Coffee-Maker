...
![Head-Height](/pictures/instantaneous_head_height.png)

![Pour-Total](/pictures/instantaneous_pour_total.png)

#### Residuals are shown for a converged time step within the final solution.

![Residuals](/pictures/residual.png)
...
![Darcy-Weisbach-Formula](/pictures/DarcyWeisbachEqn_main.png)

#### where:

![Darcy-Weisbach-Coef-a](/pictures/DarcyWeisbachCoef_a.png)  

![Darcy-Weisbach-Coef-b](/pictures/DarcyWeisbachCoef_b.png)
